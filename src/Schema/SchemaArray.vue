    ...
    <div class="array-type">
        <el-row type="flex"
            ...
            <el-col v-if="showTitle"
                ...
                <el-input v-model="items.title"
                    ...
                    <i slot="append"
                       class="el-icon-edit"
                       @click="handleAction({ eventType: 'show-edit', field: 'title' })"></i>
                </el-input>
            </el-col>
            <el-col v-if="!showTitle && showDefaultValue"
                    :span="isMock ? 4 : 5"
                    class="col-item col-item-mock">
                <el-input v-model="items.default"
                          placeholder="默认值"
                          size="small">
                    <i slot="append"
                       class="el-icon-edit"
                       @click="handleAction({ eventType: 'show-edit', field: 'default' })"></i>
                </el-input>
            </el-col>
            ...
            <el-col :span="isMock ? 4 : 5"
                ...
                <el-input v-model="items.description"
                          placeholder="备注"
                          size="small">
                    <i slot="append"
                       class="el-icon-edit"
        ...
        <div class="option-formStyle">
            <template v-if="items.type === 'array'">
                <SchemaArray :prefix="prefixArray"
                             :data="items"
                             :is-mock="isMock"
...
export default {
    ...
    beforeMount() {
        const length = this.prefix.filter(
