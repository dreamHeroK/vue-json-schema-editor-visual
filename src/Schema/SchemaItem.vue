    ...
    <div>
        <el-row type="flex"
            ...
            <el-col v-if="!showTitle && showDefaultValue"
                    :span="isMock ? 4 : 5"
                    class="col-item col-item-mock">
                <el-input v-model.trim="value.default"
                          placeholder="默认值"
                          size="small"
                          :disabled="
          ...
          ">
                ...
                <DropPlus v-if="value.type === 'object'"
                          :prefix="prefix"
                          :name="name"
        ...
        <div class="option-formStyle">
            ...
            <template v-if="value.type === 'array'">
                <schema-array :prefix="prefixArray"
                              :data="value"
                              :is-mock="isMock"
            ...
            <template v-if="value.type === 'object' && showIcon">
                <schema-object :prefix="nameArray"
                               :data="value"
                               :is-mock="isMock"
                               :show-title="showTitle"
                               :show-default-value="showDefaultValue"
