            ...
            <el-form ref="elForm"
                ...
                <el-col :span="12">
                    <el-form-item label="最小元素个数"
                                  prop="minItems">
                        <el-input-number v-model="formData.minItems"
                                         placeholder="请输入"
                                         :min="0"
                ...
                <el-col :span="12">
                    <el-form-item label="最大元素个数"
                                  prop="maxItems">
                        <el-input-number v-model="formData.maxItems"
                                         placeholder="请输入"
                                         :max="100000"
                                         :step="1"></el-input-number>
                    </el-form-item>
    ...
    methods: {
        ...
        handleConfirm() {
            this.$refs["elForm"].validate((valid) => {
                ...
                this.$jsEditorEvent.emit(
                    `schema-update-${this.initData.editorId}`,
                    {
