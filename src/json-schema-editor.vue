<template>
    <div>
        <el-button v-if="showRaw"
                   type="primary"
                   size="mini"
                   style="margin-bottom: 10px"
                   @click="handleReqBodyRaw">RAW查看</el-button>
        <div class="json-schema-vue-editor">
            <el-row type="flex"
                    ...
                    <el-row type="flex"
                        ...
                        <el-col :span="2"
                            ...
                            <span v-if="schemaData.type === 'object'"
                                ...
                                <i v-if="show"
                                   class="el-icon-caret-bottom icon-object"></i>
                                <i v-if="!show"
                ...
                <el-col v-if="showTitle"
                        :span="isMock ? 4 : 5"
                        class="col-item col-item-mock">
                    <el-input v-model="schemaData.title"
                              placeholder="标题"
              ...
              "></i>
                ...
                <el-col v-if="!showTitle && showDefaultValue"
                        :span="isMock ? 4 : 5"
                        class="col-item col-item-mock">
                    <el-input v-model="schemaData.default"
                              placeholder="默认值"
                              size="small"
                              :disabled="
            ...
            ">
              ...
              "></i>
                ...
                <el-col :span="isMock ? 4 : 5"
                        class="col-item col-item-desc"
                        v-if="showDesc">
                    <el-input v-model="schemaData.description"
                              placeholder="备注"
                              size="small"
                              :disabled="schemaData.disabled">
                        <i slot="append"
            ...
            <RawDialog v-if="showRaw"
                       ...
                       :schema="schemaData" />
            <!-- 高级设置弹窗 -->
            <BasicDialog :visible.sync="basicDialogVisible"
                         :init-data="basicModalData" />
            <StringDialog :visible.sync="settingDialogVisible.string"
                          :init-data="settingModalData" />
            <NumberDialog :visible.sync="settingDialogVisible.number"
                          :init-data="settingModalData" />
            <NumberDialog :visible.sync="settingDialogVisible.integer"
                          :init-data="settingModalData" />
            <ArrayDialog :visible.sync="settingDialogVisible.array"
                         :init-data="settingModalData" />
            <BooleanDialog :visible.sync="settingDialogVisible.boolean"
                           :init-data="settingModalData" />
            <ObjectDialog :visible.sync="settingDialogVisible.object"
                          :init-data="settingModalData" />
        </div>
    </div>
</template>
